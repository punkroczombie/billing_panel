                    ...
                    <form wire:submit.prevent="pay">
                        ...
                        @if (config('settings::tos'))
                            <div class="items-center p-1">
                                @php
                                $tos = "I agree to the <a href='https://mythicaldimensions.me/tos/' class='text-blue-500 hover:text-blue-600'>terms of service</a>"; @endphp <x-input id="tos" type="checkbox" name="tos" required
